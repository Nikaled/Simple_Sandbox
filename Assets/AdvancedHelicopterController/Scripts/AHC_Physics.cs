...
namespace alelavoie
{
    class AHC_Physics
    {
        ...
        /// <summary>
        /// Make sure the heli's altitude will stabilize relatively quickly if throttle is idling and helicopter is not tilted. 
        /// </summary>
        ...
        /// <summary>
        /// When heli is moving at high speed, it should rotate towards a position of less resistance (forward facing). 
        /// </summary>
        ...
        /// <summary>
        /// The direction of the lift should be modulated for a better experience. If the tilt angle is small (under 5 degrees), the lift angle
        /// should be dampened. This will help landing and add stability when trying to hover. In revenge, if the tilt angle is higher then 5, 
        /// the lift angle should be exagerated to gain horizontal speed more quickly. 
        /// </summary>
        ...
        /// <summary>
        /// Process additional forces to apply depending on the heli's velocity magnitude and the angle it forms with the rotor's plane. 
        /// </summary>
