...
*/
...
#if (!UNITY_EDITOR)
            isOnWhitelistedDomain = true;//SiteLock.IsOnWhitelistedDomain();
         ...
         */
        public static bool IsOnCrazyGames => Application.isEditor || (Application.platform == RuntimePlatform.WebGLPlayer);
